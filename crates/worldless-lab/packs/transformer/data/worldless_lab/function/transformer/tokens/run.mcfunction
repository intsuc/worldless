...
data modify storage transformer:request prefix_tokens set from storage worldless_lab:transformer/input prefix_tokens
data modify storage transformer:request tokenizer_id set from storage transformer:constants tokenizer_id
data modify storage transformer:request max_new_tokens set from storage worldless_lab:transformer/input max_new_tokens
execute store success score #infer_result transformer run function transformer:infer/tokens
