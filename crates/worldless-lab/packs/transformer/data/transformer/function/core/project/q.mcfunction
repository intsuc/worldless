...
function transformer:core/project/select_q.macro with storage transformer:runtime state.macro
...
data modify storage transformer:runtime state.q set from storage transformer:runtime state.projected
