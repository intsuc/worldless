...
function transformer:core/project/select_k.macro with storage transformer:runtime state.macro
...
data modify storage transformer:runtime state.k set from storage transformer:runtime state.projected
