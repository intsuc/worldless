...
data modify storage transformer:runtime state.best_id set value 254
...
execute if data storage transformer:runtime {state:{ch:"a"}} run return run function transformer:tokenize/state/510
return 1
