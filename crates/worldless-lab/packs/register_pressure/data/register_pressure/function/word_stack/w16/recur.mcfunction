...
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l2 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l3 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l4 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l5 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l6 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l7 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l8 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l9 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l10 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l11 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l12 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l13 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l14 reg_pressure
data modify storage register_pressure:state work.words append value 0
execute store result storage register_pressure:state work.words[-1] int 1 run scoreboard players get #l15 reg_pressure
scoreboard players operation #arg_x reg_pressure += #l0 reg_pressure
scoreboard players remove #remaining reg_pressure 1
execute store result score #result reg_pressure run function register_pressure:word_stack/w16/recur
execute store result score #l15 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l14 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l13 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l12 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l11 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l10 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l9 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l8 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l7 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l6 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l5 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l4 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l3 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
execute store result score #l2 reg_pressure run data get storage register_pressure:state work.words[-1]
data remove storage register_pressure:state work.words[-1]
