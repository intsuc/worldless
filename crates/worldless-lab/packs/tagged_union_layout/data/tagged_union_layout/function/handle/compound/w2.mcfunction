...
execute store result score #value tag_union run data get storage tagged_union_layout:state work.cell.payload.p0
scoreboard players operation #arm tag_union *= #factor_31 tag_union
scoreboard players operation #arm tag_union += #value tag_union
execute store result score #value tag_union run data get storage tagged_union_layout:state work.cell.payload.p1
scoreboard players operation #arm tag_union *= #factor_31 tag_union
scoreboard players operation #arm tag_union += #value tag_union
